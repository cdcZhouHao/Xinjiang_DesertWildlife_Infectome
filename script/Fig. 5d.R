...
# 2. Read data
dist_mat <- read.table("C:\\Users\\zhouhao\\OneDrive\\Desktop\\Xinjiang_Altun_Project\\04_Bacterial_Diversity\\Beta_diversity\\Beta_diversity.dist-braycurtis.table", header = TRUE, row.names = 1, sep = "\t", check.names = FALSE)
dist_obj <- as.dist(dist_mat)

group_info <- read.table("C:\\Users\\zhouhao\\OneDrive\\Desktop\\Xinjiang_Altun_Project\\04_Bacterial_Diversity\\Beta_diversity\\group.txt", header = TRUE, row.names = 1, sep = "\t")
